...
properties(
  [[$class: 'GithubProjectProperty', projectUrlStr: 'http://github.com/hmcts/postfix-role/'],
...
node {
  ws('postfix-role') { // This must be the name of the role otherwise ansible won't find the role
    try {
